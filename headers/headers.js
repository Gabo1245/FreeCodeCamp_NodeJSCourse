...
const server = http.createServer((req, res) => {
    ...
    res.write('<title> Server Worked! </title> <h1>Server gave a response sucessfully <h1>')
    res.end()
        ...
        res.write('<title>Error 404!</title> <h1> Sorry! The page you were trying to access does not exist </h1>')
        res.end()
    }
